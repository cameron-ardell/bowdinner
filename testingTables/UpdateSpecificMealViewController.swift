...
class UpdateSpecificMealViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, NSURLSessionDelegate {
    ...
    //
    //for whatever you need to do Marcus
    //
    func actualSend() {
    ...
    //
    // Sorry Marcus - tried helping but I realized I didn't know what I was doing
    // I think you need some sort of switch statement to figure out which meal this,
    // so I added a value in here called mealNumber which is an int that will tell you
    //
    func addUser(status:Int, time:String, place:String, userID:Int) {
        ...
        let data = "a=\(status)&b=\(time)&c=\(place)&d=\(userID)".dataUsingEncoding(NSUTF8StringEncoding)
